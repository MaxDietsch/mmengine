...
class DynamicSampler(Sampler):
    ...
    def __init__(self,
        ...
        self.average_sample_size = len(self.dataset) // self.num_classes
    ...
    def __iter__(self) -> Iterator[int]:
        ...
        labels = [item['gt_label'] for item in data_list]
    ...
    # set the classes or f1 scores for sampling 
...
class ROSSampler(Sampler):
    # ros_pct should be ratio between sizes of upsampled minority classes to majority class
    # any class smaller than majority class is a minority class 
    # rus_maj_pct: array in which element i in the ratio of kept elements in comparison to unkept ones of class i 
